...
export default function LiquidationTable({ data = [], loading = false, onView }) {
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                {item.requisition?.employee?.ProfileImage ? (
                                    ...
                                    <img
                                        src={`${process.env.NEXT_PUBLIC_STORAGE_URL}/storage/${item.requisition?.employee?.ProfileImage}`}
